...
public class GenericoDAOImpl<T, ID extends Serializable> implements GenericoDAO<T, ID> {
	...
	public T incluir(T object) throws ProdutoException {
		try{
			...
			e.printStackTrace();
			throw new ProdutoException(e,"Não foi possível realizar a inclusão.");
		}
		return object;
	}
	...
	public T alterar(T object) throws ProdutoException {
		try{
			...
			throw new ProdutoException(e,"Não foi possível realizar a alteração.");
		}
		return object;
	}
	...
	public T consultar(Integer id) throws ProdutoException {
		...
		try{
			...
			throw new ProdutoException(e,"Registro não encontrado.");
		}
		catch (Exception e) {
			throw new ProdutoException(e,"Não foi possível realizar a consulta.");
		}
		return object;
	}
	...
	public void excluir(Integer id) throws ProdutoException {
		try{
			...
			throw new ProdutoException(e,"Registro não encontrado para exclusão.");
		}
		catch (Exception e) {
			throw new ProdutoException(e,"Não foi possível realizar a exclusão.");
		}
	...
	public List<T> listar() throws ProdutoException {
        ...
        try {  
            ...
            throw new ProdutoException(e, "Problemas na localização dos objetos");  
        }  
        return lista;  
     }
